...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('python-resource-monitor.rsmLength', () => {
        ...
        // Handle accept
        lengthbox.onDidAccept((e) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield panel.webview.postMessage({ type: 'length', value: num });
...
function postData(pid, key, time, value) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // .then()
            yield panel.webview.postMessage({ pid: pid, type: key, time: time, value: value }).then(nop, nop);
        }
        catch (_a) {
